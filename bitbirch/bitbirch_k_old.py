...
class _BFNode:
    ...
    def insert_bf_subcluster(self, subcluster, set_bits, ps, singly, flag, num_centroids):
        ...
        if closest_subcluster.child_ is not None:
            ...
            split_child = closest_subcluster.child_.insert_bf_subcluster(subcluster, set_bits, ps, singly, flag, num_centroids)
